        ...
        <div className="row">
            <div className="col-ms-6 col-sm-6">
                <div className="contact-info-text">
                    ...
                    <h5>Fill in the form and drop an email</h5>
                </div>
                <div className="contact-information">
                    <ul className="contact-list">
                        ...
                        <li>
                            ...
                            <h4>street #12 gulburg phase II Lahore</h4>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="col-md-6 col-sm-12 ">
                <div className="enter-contact-info">
                    <input className="form-control " type="text" placeholder="Full Name"/>
                    <input className="form-control" type="text" placeholder="Email Address"/>
                    <input className="form-control" type="text" placeholder="Subject"/>
                    <textarea className="form-control" id="exampleFormControlTextarea1" rows="3">Message</textarea>
